...
if __name__ == "__main__":
    ...
    dataset_file = ["dataset_NR_256_str123",
                    "dataset_NR_256_str124",
                    "dataset_NR_256_str134",
                    "dataset_NR_256_str234"]
    dataset_base_file = ["dataset_NR_256_dir1_r270",
                         "dataset_NR_256_dir2_r90",
                         "dataset_NR_256_dir3_r90",
                         "dataset_NR_256_dir4_r180"]

    head_name = [dataset + "_test\\" + date + "_256(50%)_" + str(train_num[0]) + "_" + dataset + "(str123)",
                 dataset + "_test\\" + date + "_256(50%)_" + str(train_num[0]) + "_" + dataset + "(str124)",
                 dataset + "_test\\" + date + "_256(50%)_" + str(train_num[0]) + "_" + dataset + "(str134)",
                 dataset + "_test\\" + date + "_256(50%)_" + str(train_num[0]) + "_" + dataset + "(str234)"]
    ...
    #                                        dataset_base_file[1],
    #                                        dataset_base_file[2]],
    #                     dataset_totalNum_list=[6796, 6888, 6840],
    ...
    #                                        dataset_base_file[1],
    #                                        dataset_base_file[3]],
    #                     dataset_totalNum_list=[6796, 6888, 6894],
    ...
    #                                        dataset_base_file[2],
    #                                        dataset_base_file[3]],
    #                     dataset_totalNum_list=[6796, 6840, 6894],
    ...
    #                                        dataset_base_file[2],
    #                                        dataset_base_file[3]],
    #                     dataset_totalNum_list=[6888, 6840, 6894],
