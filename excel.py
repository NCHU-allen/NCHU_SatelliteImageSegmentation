...
class Excel(object):
    ...
    def write_loss_and_iou(self, record, loss, val_loss, iou, avr_iou):
        ...
        self.write_excel('b2', 'loss')
        self.write_excel('c2', 'val_loss')
        self.write_excel('b3', loss, vertical=True)
        self.write_excel('c3', val_loss, vertical=True)
        self.write_excel('d2', 'iou')
        self.write_excel('e2', 'avr_iou')
        self.write_excel('d3', iou, vertical=True)
        self.write_excel('e3', avr_iou, vertical=True)
